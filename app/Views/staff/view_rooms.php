                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ms-3">
                                    <h6 class="mb-1">Total Bedspaces</h6>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ms-3">
                                    <h6 class="mb-1">Occupied Bedspaces</h6>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ms-3">
                                    <h6 class="mb-1">Unoccupied Bedspaces</h6>
                                    <h4 class="mb-0">5</h4>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center py-3">
                        ...
                        <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addHostelModal">
                            <i class="fas fa-plus me-2"></i>Add New Rooms
                        </button>
                    </div>
                    <div class="card-body">
                            ...
                            <table class="table table-hover" id="hostelTable">
                                ...
                                <tbody>
                                    ...
                                    foreach ($rooms as $hostel) : ?>
                                        <tr>
                                            <td><?php echo $i++; ?></td>
                                            <td><?php echo $hostel['room_name']; ?></td>`
                                            <td><?php echo $hostel['capacity']; ?></td>
                                            <td><?php echo $hostel['status']; ?></td>
                                            <td>
                                                <div class="btn-group">
                                                   
                                                    <a href="<?php echo site_url('staff/view_bedspaces/'.$hostel['id']); ?>">
