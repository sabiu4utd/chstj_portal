                            ...
                            <div class="card-body">
                                <table class="table table-striped">
                                    <thead>
                                        <tr>
                                            <td colspan="8" class="text-center">
                                                <strong><?php echo $program['program'] . '  ' . $session . '  ' . $level . ' Level  ' . "Fee Schedules"; ?></strong>
                                    ...
                                    <tbody>
                                        ...
                                        <?php if (empty($fees)) { ?>
                                            <tr>
                                                <td colspan="8" class="text-center">No Fees found</td>
                                            </tr>
                                        <?php } else { ?>
                                        ...
                                        foreach ($fees as $fee) { ?>
                                            <tr>
                                                <td><?php echo $sn++; ?></td>
                                                <td><?php echo $fee['item']; ?></td>
                                                <td><?php echo $fee['amount']; ?></td>
                                                <td><?php echo $fee['level']; ?></td>
                                                <td><?php echo $fee['session']; ?></td>
                                                <?php $sum += $fee['amount']; ?>
                                                <td>
                                                    <!-- <a href="<?php echo site_url('staff/edit_fee/' . $fee['id']); ?>" class="btn btn-primary btn-sm">Edit</a> -->
                                                    <a href="<?php echo site_url('staff/delete_fee/' . $fee['id']); ?>" class="btn btn-danger btn-sm">X</a>
                                                </td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
