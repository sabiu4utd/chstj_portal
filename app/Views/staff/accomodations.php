                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-hover" id="hostelTable">
                                <thead>
                                    <tr>
                                        <th>SN</th>
                                        <th>Hostel Name</th>
                                ...
                                <tbody>
                                    ...
                                    foreach ($hostels as $hostel) : ?>
                                        <tr>
                                            ...
                                            <td><?php echo $hostel['hostel_gender']; ?></td>
                                            <td><?php echo $hostel['hostel_location']; ?></td>
                                            <td><?php echo $hostel['no_rooms']; ?></td>
                                           <td><a href="<?php echo site_url('staff/pending_applicants/'.$hostel['hostelid']); ?>">Pending</a></td>
                                            <td><a href="<?php echo site_url('staff/approved_applicants/'.$hostel['hostelid']); ?>">Approved</a></td>
                                            <td><a href="<?php echo site_url('staff/declined_applicants/'.$hostel['hostelid']); ?>">Declined</a></td>


                                            <td>
                                                <div class="btn-group">
                                                   
                                                    <a href="<?php echo site_url('staff/view_rooms/'.$hostel['hostelid']); ?>">
