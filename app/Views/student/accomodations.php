...
foreach ($hostels as $hostel) {
    $accomodation .= "<option value='" . $hostel['hostelid'] . "'>" . $hostel['hostel_name'] . "</option>";
}
    ...
    <div class="d-flex">
        ...
        <div class="flex-grow-1 bg-light">
            ...
            <div class="card mb-4">
                ...
                <?php if (isset($current_reservation) && $current_reservation['reservation_status'] == 'Pending') {
                ...
                } elseif (isset($current_reservation) && $current_reservation['reservation_status'] == "Approved") { ?>
                ...
                <?php } else { ?>
                    <div class="card-body">
                        <form method="post" class="row g-3" action="<?php echo site_url('student/make_reservation') ?>">
                            ...
                            <div class="col-md-4">
                                <label for="bedspace" class="form-label">Rooms</label>
                                <select name="roomid" id="roomid" class="form-select" required>
                                    <option value="" selected disabled>Choose Room...</option>
                                </select>
                            </div>
                            <div class="col-md-4">
                                <label for="bedspace" class="form-label">Bedspace</label>
                                <select name="bedspaceid" id="bedspaceid" class="form-select" required>
                                    <option value="" selected disabled>Choose bedspace...</option>
                                </select>
                            </div>
        ...
        function payWithPaystack() {
            ...
            paystack.newTransaction({
                ...
                onSuccess: (transaction) => {
                    ...
                    location.href = "hostel_payments/" + transaction.reference;
